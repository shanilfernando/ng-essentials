...
[travis-badge]: https://travis-ci.org/filipesilva/angular-ng-essentials.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-ng-essentials
...
1. Create a project folder (you can call it `ng-essentials` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-ng-essentials.git
cd angular-ng-essentials
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-ng-essentials/archive/master.zip)
...
Use your editor to search the project for all instances of `angular-ng-essentials` and change it
